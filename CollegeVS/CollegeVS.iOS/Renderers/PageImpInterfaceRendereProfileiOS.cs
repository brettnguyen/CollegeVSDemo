...
[assembly: ExportRenderer(typeof(CLGVSProfile), typeof(PageImpInterfaceRendereProfileiOS))]
namespace CollegeVS.iOS
{
    ...
    public class PageImpInterfaceRendereProfileiOS : PageRenderer, ISlideOverKitPageRendereriOS
    {
        ...
        public PageImpInterfaceRendereProfileiOS()
        {
