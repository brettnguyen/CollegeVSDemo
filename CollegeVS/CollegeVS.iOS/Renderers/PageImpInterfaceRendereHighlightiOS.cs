...
[assembly: ExportRenderer(typeof(HighlightPage), typeof(PageImpInterfaceRendereHighlightiOS))]
namespace CollegeVS.iOS
{
    ...
    public class PageImpInterfaceRendereHighlightiOS : PageRenderer, ISlideOverKitPageRendereriOS
    {
        ...
        public PageImpInterfaceRendereHighlightiOS()
        {
